...
public class InscriptionAnnuelle {
	...
	public InscriptionAnnuelle( int annee, int etat, String type, int rang, String validation,String mention, String plusInfos, Niveau niveau, Etudiant etudiant) {
		super();
		this.annee = annee;
		this.etat = etat;
		this.type = type;
	...
	public InscriptionAnnuelle() {
		System.out.println("consctructeur InscriptionAnnuelle");
	}
