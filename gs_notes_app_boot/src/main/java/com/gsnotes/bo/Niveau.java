...
public class Niveau {
	...
	public Niveau(Long idNiveau, String alias, String titre, Filiere filiere, Niveau niveauSuivant) {
		super();
	...
	public Niveau() {
		System.out.println("constructeur niveau");
	}

	@Override
	public String toString() {
		return "Niveau [idNiveau=" + idNiveau + ", alias=" + alias + ", titre=" + titre + ", filiere=" + filiere
