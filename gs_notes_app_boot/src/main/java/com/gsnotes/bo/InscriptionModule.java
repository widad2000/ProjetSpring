...
public class InscriptionModule {
	...
	public InscriptionModule( double noteSN, double noteSR, double noteFinale,
			String validation, String plusInfos, Module module, InscriptionAnnuelle inscriptionAnnuelle) {
		super();
		this.noteSN = noteSN;
		this.noteSR = noteSR;
	...
	public String toString() {
		return "InscriptionModule [idInscriptionModule=" + idInscriptionModule + ", noteSN=" + noteSN + ", noteSR="
				+ noteSR + ", noteFinale=" + noteFinale + ", validation=" + validation + ", plusInfos=" + plusInfos
				+ ", module=" + module + ", inscriptionAnnuelle=" + inscriptionAnnuelle + "]";
	}
