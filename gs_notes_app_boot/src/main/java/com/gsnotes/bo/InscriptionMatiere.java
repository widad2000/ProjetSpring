...
public class InscriptionMatiere {
	...
	public InscriptionMatiere(double noteSN, double noteSR, double noteFinale, String validation, String plusInfos,
			double coefficient, Element matiere, InscriptionAnnuelle inscriptionAnnuelle) {
		super();
		this.noteSN = noteSN;
		this.noteSR = noteSR;
